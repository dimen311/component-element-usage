  ...
  constructor(filePath, label, lineNumber, children) {
    ...
    if (children) {
      this.command = {
        command: "vscode.open",
        title: "Open File",
        arguments: [vscode2.Uri.file(this.filePath)]
      };
    } else {
      this.command = {
        command: "extension.openFileAtLine",
        title: "Open File",
        arguments: [vscode2.Uri.file(this.filePath), this.lineNumber]
      };
    }
  }
...
function activate(context) {
  ...
  let openFileCommand = vscode3.commands.registerCommand("extension.openFileAtLine", async (filePath, lineNumber) => {
    await vscode3.commands.executeCommand("vscode.open", filePath, {
    ...
    const editor = vscode3.window.activeTextEditor;
    if (editor) {
      const position = new vscode3.Position(lineNumber - 1, 0);
